    ...
    <app-navbar8>
      <template v-slot:link1>
        <div class="home-fragment100">
          <span class="home-text100 thq-link thq-body-small">#</span>
        </div>
      </template>
      <template v-slot:link2>
        <div class="home-fragment101">
          <span class="home-text101 thq-link thq-body-small">#chi-siamo</span>
        </div>
      </template>
      <template v-slot:link3>
        <div class="home-fragment102">
          <span class="home-text102 thq-link thq-body-small">#progetti</span>
        </div>
      </template>
      <template v-slot:link4>
        <div class="home-fragment103">
          <span class="home-text103 thq-link thq-body-small">#contatti</span>
        </div>
      </template>
      <template v-slot:page1>
        <div class="home-fragment104">
          <span class="home-text104 thq-body-large">Home</span>
        </div>
      </template>
      <template v-slot:page2>
        <div class="home-fragment105">
          <span class="home-text105 thq-body-large">Chi Siamo</span>
        </div>
      </template>
      <template v-slot:page3>
        <div class="home-fragment106">
          <span class="home-text106 thq-body-large">Progetti</span>
        </div>
      </template>
      <template v-slot:page4>
        <div class="home-fragment107">
          <span class="home-text107 thq-body-large">Contatti</span>
        </div>
      </template>
      <template v-slot:action1>
        <div class="home-fragment108">
          <span class="home-text108">Iscriviti ora</span>
        </div>
      </template>
      <template v-slot:action2>
        <div class="home-fragment109">
          <span class="home-text109">Fai una donazione</span>
        </div>
      </template>
      <template v-slot:page1Description>
        <div class="home-fragment110">
          <span class="home-text110 thq-body-small">
      ...
      <template v-slot:page2Description>
        <div class="home-fragment111">
          <span class="home-text111 thq-body-small">
      ...
      <template v-slot:page4Description>
        <div class="home-fragment113">
          <span class="home-text113 thq-body-small">
    ...
    <app-hero17>
      <template v-slot:action1>
        <div class="home-fragment114">
          <span class="home-text114 thq-body-small">Main action</span>
        </div>
      </template>
      <template v-slot:action2>
        <div class="home-fragment115">
          <span class="home-text115 thq-body-small">Secondary action</span>
        </div>
      </template>
    ...
    <app-features24>
      <template v-slot:feature1Title>
        <div class="home-fragment118">
          <span class="home-text118 thq-heading-2">
      ...
      <template v-slot:feature2Title>
        <div class="home-fragment119">
          <span class="home-text119 thq-heading-2">
      ...
      <template v-slot:feature3Title>
        <div class="home-fragment120">
          <span class="home-text120 thq-heading-2">
      ...
      <template v-slot:feature1Description>
        <div class="home-fragment121">
          <span class="home-text121 thq-body-small">
      ...
      <template v-slot:feature3Description>
        <div class="home-fragment123">
          <span class="home-text123 thq-body-small">
    ...
    <app-cta26>
      <template v-slot:action1>
        <div class="home-fragment124">
          <span class="home-text124">Iscriviti ora</span>
        </div>
      </template>
      <template v-slot:content1>
        <div class="home-fragment125">
          <span class="home-text125 thq-body-large">
            Scopri come puoi contribuire alla nostra missione e diventare parte
            della nostra comunità di scalpellini.
          </span>
        </div>
      </template>
      <template v-slot:heading1>
    ...
    <app-features25>
      <template v-slot:feature1Title>
        <div class="home-fragment127">
          <span class="home-text127 thq-heading-2">Lavoro Artigianale</span>
        </div>
      </template>
      <template v-slot:feature2Title>
        <div class="home-fragment128">
          <span class="home-text128 thq-heading-2">Tradizione</span>
        </div>
      </template>
      <template v-slot:feature3Title>
        <div class="home-fragment129">
          <span class="home-text129 thq-heading-2">Sostenibilità</span>
        </div>
      </template>
      <template v-slot:feature1Description>
        <div class="home-fragment130">
          <span class="home-text130 thq-body-small">
            I nostri maestri artigiani creano opere d&apos;arte uniche utilizzando
            antiche tecniche di lavorazione della pietra.
          </span>
        </div>
      </template>
      <template v-slot:feature2Description>
    ...
    <app-pricing14>
      <template v-slot:plan1>
        <div class="home-fragment133">
          <span class="home-text133 thq-body-large">Piano Base</span>
        </div>
      </template>
      <template v-slot:plan2>
        <div class="home-fragment134">
          <span class="home-text134 thq-body-large">Piano Avanzato</span>
        </div>
      </template>
      <template v-slot:plan3>
        <div class="home-fragment135">
          <span class="home-text135 thq-body-large">Piano Premium</span>
        </div>
      </template>
      <template v-slot:plan11>
        <div class="home-fragment136">
          <span class="home-text136 thq-body-large">Basic plan</span>
        </div>
      </template>
      <template v-slot:plan21>
        <div class="home-fragment137">
          <span class="home-text137 thq-body-large">Business plan</span>
        </div>
      </template>
      <template v-slot:plan31>
        <div class="home-fragment138">
          <span class="home-text138 thq-body-large">Enterprise plan</span>
        </div>
      </template>
      <template v-slot:content1>
      ...
      <template v-slot:content2>
        <div class="home-fragment140">
          <span class="home-text140 thq-body-large">
            <span>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              <span v-html="rawyoju"></span>
            </span>
            <span><span v-html="raw39vw"></span></span>
          </span>
        </div>
      </template>
      <template v-slot:heading1>
        <div class="home-fragment141">
          <span class="home-text143 thq-heading-2">Pricing plan</span>
        </div>
      </template>
      <template v-slot:plan1Price>
        <div class="home-fragment142">
          <span class="home-text144 thq-heading-3">€50 al mese</span>
        </div>
      </template>
      <template v-slot:plan2Price>
        <div class="home-fragment143">
          <span class="home-text145 thq-heading-3">€100 al mese</span>
        </div>
      </template>
      <template v-slot:plan3Price>
        <div class="home-fragment144">
          <span class="home-text146 thq-heading-3">€200 al mese</span>
        </div>
      </template>
      <template v-slot:plan1Action>
        <div class="home-fragment145">
          <span class="home-text147 thq-body-small">Iscriviti ora</span>
        </div>
      </template>
      <template v-slot:plan1Price1>
        <div class="home-fragment146">
          <span class="home-text148 thq-heading-3">$200/yr</span>
        </div>
      </template>
      <template v-slot:plan1Yearly>
        <div class="home-fragment147">
          <span class="home-text149 thq-body-large">or $200 yearly</span>
        </div>
      </template>
      <template v-slot:plan2Action>
        <div class="home-fragment148">
          <span class="home-text150 thq-body-small">Iscriviti ora</span>
        </div>
      </template>
      <template v-slot:plan2Price1>
        <div class="home-fragment149">
          <span class="home-text151 thq-heading-3">$299/yr</span>
        </div>
      </template>
      <template v-slot:plan2Yearly>
        <div class="home-fragment150">
          <span class="home-text152 thq-body-large">or $299 yearly</span>
        </div>
      </template>
      <template v-slot:plan3Action>
        <div class="home-fragment151">
          <span class="home-text153 thq-body-small">Iscriviti ora</span>
        </div>
      </template>
      <template v-slot:plan3Price1>
        <div class="home-fragment152">
          <span class="home-text154 thq-heading-3">$499/yr</span>
        </div>
      </template>
      <template v-slot:plan3Yearly>
        <div class="home-fragment153">
          <span class="home-text155 thq-body-large">or $499 yearly</span>
        </div>
      </template>
      <template v-slot:plan1Action1>
        <div class="home-fragment154">
          <span class="home-text156 thq-body-small">Get started</span>
        </div>
      </template>
      <template v-slot:plan1Yearly1>
        <div class="home-fragment155">
          <span class="home-text157 thq-body-large">or $20 monthly</span>
        </div>
      </template>
      <template v-slot:plan2Action1>
        <div class="home-fragment156">
          <span class="home-text158 thq-body-small">Get started</span>
        </div>
      </template>
      <template v-slot:plan2Yearly1>
        <div class="home-fragment157">
          <span class="home-text159 thq-body-large">or $29 monthly</span>
        </div>
      </template>
      <template v-slot:plan3Action1>
        <div class="home-fragment158">
          <span class="home-text160 thq-body-small">Get started</span>
        </div>
      </template>
      <template v-slot:plan3Yearly1>
        <div class="home-fragment159">
          <span class="home-text161 thq-body-large">or $49 monthly</span>
        </div>
      </template>
      <template v-slot:plan1Feature1>
        <div class="home-fragment160">
          <span class="home-text162 thq-body-small">
      ...
      <template v-slot:plan1Feature2>
        <div class="home-fragment161">
          <span class="home-text163 thq-body-small">Supporto via email</span>
        </div>
      </template>
      <template v-slot:plan1Feature3>
        <div class="home-fragment162">
          <span class="home-text164 thq-body-small">Aggiornamenti mensili</span>
        </div>
      </template>
      <template v-slot:plan2Feature1>
        <div class="home-fragment163">
          <span class="home-text165 thq-body-small">
      ...
      <template v-slot:plan2Feature2>
        <div class="home-fragment164">
          <span class="home-text166 thq-body-small">
      ...
      <template v-slot:plan2Feature3>
        <div class="home-fragment165">
          <span class="home-text167 thq-body-small">
      ...
      <template v-slot:plan3Feature1>
        <div class="home-fragment167">
          <span class="home-text169 thq-body-small">
      ...
      <template v-slot:plan3Feature2>
        <div class="home-fragment168">
          <span class="home-text170 thq-body-small">
      ...
      <template v-slot:plan3Feature3>
        <div class="home-fragment169">
          <span class="home-text171 thq-body-small">
      ...
      <template v-slot:plan3Feature4>
        <div class="home-fragment170">
          <span class="home-text172 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      ...
      <template v-slot:plan1Feature11>
        <div class="home-fragment172">
          <span class="home-text174 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      ...
      <template v-slot:plan1Feature31>
        <div class="home-fragment174">
          <span class="home-text176 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan2Feature11>
        <div class="home-fragment175">
          <span class="home-text177 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan2Feature21>
        <div class="home-fragment176">
          <span class="home-text178 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan2Feature31>
        <div class="home-fragment177">
          <span class="home-text179 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan2Feature41>
        <div class="home-fragment178">
          <span class="home-text180 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan3Feature11>
        <div class="home-fragment179">
          <span class="home-text181 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan3Feature21>
        <div class="home-fragment180">
          <span class="home-text182 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan3Feature31>
        <div class="home-fragment181">
          <span class="home-text183 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan3Feature41>
        <div class="home-fragment182">
          <span class="home-text184 thq-body-small">Feature text goes here</span>
        </div>
      </template>
      <template v-slot:plan3Feature51>
        <div class="home-fragment183">
          <span class="home-text185 thq-body-small">Feature text goes here</span>
        </div>
      </template>
    </app-pricing14>
    <app-steps2>
      ...
      <template v-slot:step3Title>
        <div class="home-fragment186">
          <span class="home-text188 thq-heading-2">Sostieni la nostra causa</span>
        </div>
      </template>
      <template v-slot:step4Title>
        <div class="home-fragment187">
          <span class="home-text189 thq-heading-2">Diventa un volontario</span>
        </div>
      </template>
      ...
      <template v-slot:step4Description>
        <div class="home-fragment191">
          <span class="home-text193 thq-body-small">
            Se sei appassionato di pietra e desideri mettere le tue competenze al
            servizio della comunità, contattaci per diventare un volontario APS
            Pietra Maiella.
          </span>
        </div>
      </template>
    ...
    <app-testimonial17>
      <template v-slot:review1>
        <div class="home-fragment192">
          <span class="home-text194 thq-body-small">5 stelle</span>
        </div>
      </template>
      <template v-slot:review2>
        <div class="home-fragment193">
          <span class="home-text195 thq-body-small">
            Il team di APS Pietra Maiella ha realizzato un progetto su misura per
            le mie esigenze. Professionali e puntuali, li consiglio vivamente.
          </span>
        </div>
      </template>
      <template v-slot:review3>
        <div class="home-fragment194">
          <span class="home-text196 thq-body-small">
            Servizio impeccabile e risultati sorprendenti. APS Pietra Maiella ha
            trasformato la mia idea in realtà con competenza e passione.
          </span>
        </div>
      </template>
      <template v-slot:review4>
        <div class="home-fragment195">
          <span class="home-text197 thq-body-small">
            Professionisti eccezionali nel settore della lavorazione della pietra.
            Consiglio vivamente il loro lavoro.
          </span>
        </div>
      </template>
      <template v-slot:content1>
        <div class="home-fragment196">
          <span class="home-text198 thq-body-small">
            Sono rimasto estremamente soddisfatto del lavoro svolto da APS Pietra
            Maiella. La loro attenzione ai dettagli e la maestria nel lavorare la
            pietra sono davvero impressionanti.
          </span>
        </div>
      </template>
      <template v-slot:heading1>
        <div class="home-fragment197">
          <span class="home-text199 thq-heading-2">Testimonianze</span>
        </div>
      </template>
      <template v-slot:author1Name>
        <div class="home-fragment198">
          <span class="home-text200 thq-body-large">Giovanni Rossi</span>
        </div>
      </template>
      <template v-slot:author2Name>
        <div class="home-fragment199">
          <span class="home-text201 thq-body-large">Maria Bianchi</span>
        </div>
      </template>
      <template v-slot:author3Name>
        <div class="home-fragment200">
          <span class="home-text202 thq-body-large">Luca Verdi</span>
        </div>
      </template>
      <template v-slot:author4Name>
        <div class="home-fragment201">
          <span class="home-text203 thq-body-large">Elena Rossetti</span>
        </div>
      </template>
      <template v-slot:author1Position>
        <div class="home-fragment202">
          <span class="home-text204 thq-body-small">Architetto</span>
        </div>
      </template>
      <template v-slot:author2Position>
        <div class="home-fragment203">
          <span class="home-text205 thq-body-small">Interior Designer</span>
        </div>
      </template>
      <template v-slot:author3Position>
        <div class="home-fragment204">
          <span class="home-text206 thq-body-small">Imprenditore</span>
        </div>
      </template>
      <template v-slot:author4Position>
        <div class="home-fragment205">
          <span class="home-text207 thq-body-small">Restauratrice</span>
        </div>
      </template>
    </app-testimonial17>
    <app-contact10>
      ...
      <template v-slot:heading1>
        <div class="home-fragment207">
          <span class="home-text209 thq-heading-2">Contatti</span>
        </div>
      </template>
      <template v-slot:location1>
        <div class="home-fragment208">
          <span class="home-text210 thq-heading-3">Sede Principale</span>
        </div>
      </template>
      <template v-slot:location2>
        <div class="home-fragment209">
          <span class="home-text211 thq-heading-3">Sede Secondaria</span>
        </div>
      </template>
      <template v-slot:location1Description>
        <div class="home-fragment210">
          <span class="home-text212 thq-body-large">
      ...
      <template v-slot:location2Description>
        <div class="home-fragment211">
          <span class="home-text213 thq-body-large">
    ...
    <app-footer4>
      <template v-slot:link1>
        <div class="home-fragment212">
          <span class="home-text214 thq-body-small">Home</span>
        </div>
      </template>
      <template v-slot:link2>
        <div class="home-fragment213">
          <span class="home-text215 thq-body-small">Chi siamo</span>
        </div>
      </template>
      <template v-slot:link3>
        <div class="home-fragment214">
          <span class="home-text216 thq-body-small">Progetti</span>
        </div>
      </template>
      <template v-slot:link4>
        <div class="home-fragment215">
          <span class="home-text217 thq-body-small">Contatti</span>
        </div>
      </template>
      <template v-slot:link5>
        <div class="home-fragment216">
          <span class="home-text218 thq-body-small">Donazioni</span>
        </div>
      </template>
      <template v-slot:termsLink>
        <div class="home-fragment217">
          <span class="home-text219 thq-body-small">Termini e condizioni</span>
        </div>
      </template>
      <template v-slot:cookiesLink>
        <div class="home-fragment218">
          <span class="home-text220 thq-body-small">Informativa sui cookie</span>
        </div>
      </template>
      <template v-slot:privacyLink>
        <div class="home-fragment219">
          <span class="home-text221 thq-body-small">
...
export default {
  ...
  metaInfo: {
    title: 'Vivid Other Manatee',
    meta: [
      {
        property: 'og:title',
        content: 'Vivid Other Manatee',
      },
    ],
  },
}
