          ...
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link1">
              ...
              <div class="footer4-fragment5">
                <span class="footer4-text18 thq-body-small">Home</span>
              </div>
            </slot>
          </a>
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link2">
              ...
              <div class="footer4-fragment2">
                <span class="footer4-text15 thq-body-small">Chi siamo</span>
              </div>
            </slot>
          </a>
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link3">
              ...
              <div class="footer4-fragment4">
                <span class="footer4-text17 thq-body-small">Progetti</span>
              </div>
            </slot>
          </a>
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link4">
              ...
              <div class="footer4-fragment6">
                <span class="footer4-text19 thq-body-small">Contatti</span>
              </div>
            </slot>
          </a>
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link5">
              ...
              <div class="footer4-fragment1">
                <span class="footer4-text14 thq-body-small">Donazioni</span>
              </div>
            </slot>
          </a>
        </div>
            ...
            <span>
              <slot name="cookiesLink">
                ...
                <div class="footer4-fragment3">
                  <span class="footer4-text16 thq-body-small">
