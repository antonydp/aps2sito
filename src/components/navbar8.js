          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text15">Iscriviti ora</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text27">Fai una donazione</span>
                  </Fragment>
                )}
              </span>
            </button>
...
Navbar8.defaultProps = {
  ...
  action1: undefined,
  page2ImageAlt: 'Immagine Chi Siamo',
  link2: undefined,
  linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'Logo APS Pietra Maiella',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Immagine Progetti',
  ...
  page2: undefined,
  link4: undefined,
  page4ImageAlt: 'Immagine Contatti',
