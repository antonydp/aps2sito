          ...
          <button class="navbar8-action11 thq-button-filled thq-button-animated">
            <span class="thq-body-small">
              <slot name="action1">
                ...
                <div><span>Iscriviti ora</span></div>
              </slot>
            </span>
          </button>
          <button class="navbar8-action21 thq-button-outline thq-button-animated">
            <span class="thq-body-small">
              <slot name="action2">
                ...
                <div><span>Fai una donazione</span></div>
              </slot>
            </span>
          </button>
        </div>
            ...
            <a :href="link1Url">
              <slot name="link1">
                ...
                <div class="navbar8-fragment21">
                  <span class="navbar8-text25 thq-link thq-body-small">#</span>
                </div>
              </slot>
            </a>
            <a :href="link2Url">
            ...
            <a :href="link3Url">
              <slot name="link3">
                ...
                <div class="navbar8-fragment18">
                  <span class="navbar8-text22 thq-link thq-body-small">
                    #progetti
                  </span>
                </div>
              </slot>
                ...
                <span>
                  <slot name="link4">
                    ...
                    <div class="navbar8-fragment15">
                      <span class="navbar8-text19 thq-link thq-body-small">
                        #contatti
                      </span>
                    </div>
                  </slot>
                    ...
                    <div class="navbar8-content4">
                      ...
                      <span>
                        <slot name="page4Description">
                          ...
                          <div>
                            <span>Contattaci per ulteriori informazioni</span>
                          </div>
                        </slot>
                      </span>
                    </div>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment16">
                    <span class="navbar8-text20">Iscriviti ora</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment12">
                    <span class="navbar8-text16">Fai una donazione</span>
                  </div>
                </slot>
              </span>
            </button>
                ...
                <span>
                  <slot name="page1">
                    ...
                    <div class="navbar8-fragment20">
                      <span class="navbar8-text24 thq-body-large">Home</span>
                    </div>
                  </slot>
                </span>
                <span>
                  <slot name="page1Description">
                    ...
                    <div class="navbar8-fragment13">
                      <span class="navbar8-text17 thq-body-small">
                        Pagina principale dell&apos;APS Pietra Maiella
                      </span>
                    </div>
                  </slot>
                ...
                <span>
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment19">
                      <span class="navbar8-text23 thq-body-large">Chi Siamo</span>
                    </div>
                  </slot>
                </span>
                <span>
                ...
                <span>
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment23">
                      <span class="navbar8-text27 thq-body-large">Progetti</span>
                    </div>
                  </slot>
                </span>
                <span>
                ...
                <span>
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment17">
                      <span class="navbar8-text21 thq-body-large">Contatti</span>
                    </div>
                  </slot>
                </span>
                <span>
                  <slot name="page4Description">
                    ...
                    <div class="navbar8-fragment11">
                      <span class="navbar8-text15 thq-body-small">
...
export default {
  ...
  props: {
    ...
    page3ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1561956021-947f09ae0101?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTk0ODU3MXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    link2Url: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page4ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTk0ODU3MXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    logoAlt: {
      type: String,
      default: 'Logo APS Pietra Maiella',
    },
    linkUrlPage2: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page2ImageAlt: {
      type: String,
      default: 'Immagine Chi Siamo',
    },
    page2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1611832568372-6d6a6d96ac22?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTk0ODU3MXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page1ImageAlt: {
      type: String,
      default: 'Immagine Home',
    },
    page3ImageAlt: {
      type: String,
      default: 'Immagine Progetti',
    },
    page1ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1534113414509-0eec2bfb493f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyOTk0ODU3MXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    logoSrc: {
      type: String,
      default:
